...
urspr\"unglich  als  vereinfachte  graphische Methode  zur  Approximation  der
...
und    graphisch   erl\"autert. Die    Durchrechnung   der    Phasengangmethode
...
\input{sections/fachlicherHintergrund/phasengangPI.tex}

\clearpage
\subsection{Reglerdimensionierung mittels Phasengangmethode: PID-Regler}
\label{subs:phasengang:pid}
\input{sections/fachlicherHintergrund/phasengangPID.tex}

\clearpage
\subsection{Vergleich mit Software-Tool}
\label{subs:tool:results}
\input{sections/fachlicherHintergrund/toolResults.tex}
...
\label{subs:fft}
\input{sections/fachlicherHintergrund/fft.tex}
