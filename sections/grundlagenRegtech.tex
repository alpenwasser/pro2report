...
(Abb.\ref{fig:PRegler}) dargestellt.
...
Regleabweichung  und  der  Integrierzeit  $T_i$ ab. Hier  gilt  die  Regel: Je
gr\"osser die Integierzeit,  je langsamer steigt die  Kurve. Das Verhalten des
I-Reglers ist in sinem Blockschaltbild (Abb.\ref{fig:IRegler}) dargestellt.
...
(Abb.\ref{fig:DRegler}) symbolisch dargestellt.
