...
\begin{figure}[h!, width=\pagewidth]
    \centering
    \includegraphics[width=.6\textwidth]{images/comparisonPI015.png}
    \caption{%
...
\begin{figure}[h!, width=\pagewidth]
    \centering
    \includegraphics[width=.6\textwidth]{images/comparisonPID015.png}
    \caption{%
...
\begin{figure}[h!, width=\pagewidth]
    \centering
    \includegraphics[width=.6\textwidth]{images/comparisonPID002optimisations.png}
    \caption{%
        Schrittantworten    des   geschlossenen    Regelkreises (PID-Regler),
